...
static void test_cagliostr_records() {
  ...
  _ok(!insert_record(ev), "duplicated event must be rejected");

  // tests for delete_record_by_id
  _ok(delete_record_by_id("bb97556f36930838b8593b9e3dd130182e77f34ddf6c8e351b41b1753dc2580b") == 0, "delete_record_by_id should be failed for invalid id");

  _ok(delete_record_by_id("bb97556f36930838b8593b9e3dd130182e77f34ddf6c8e351b41b1753dc2580a") == 1, "delete_record_by_id should be succeeded for valid id");
